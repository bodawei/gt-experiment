...
**YOU ARE IN: `gt_experiment/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/gt_experiment/` (rig root) or other directories
...
**Your mail address:** `gt_experiment/polecats/obsidian`
**Your rig:** gt_experiment
**Your Witness:** `gt_experiment/witness`
...
| Ask Witness for help | `gt mail send gt_experiment/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`gt_experiment/witness`) when:
...
```bash
gt mail send gt_experiment/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
